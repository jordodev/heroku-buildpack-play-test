...
download_play_official() {
  ...
  local playUrl="https://github.com/Living-Room-of-Satoshi/play1/releases/download/${playVersion}/${playZipFile}"
...
Please check that the version ${playVersion} is correct in your conf/dependencies.yml"
    ...
    echo "Downloading ${playZipFile} from https://github.com/Living-Room-of-Satoshi/play1/releases/download" | indent
